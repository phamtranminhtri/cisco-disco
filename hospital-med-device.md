...
* CORE-SW1: active for (10,20,30,40), standby (50,70,90)
```
int vlan 10
no shut
...
* CORE-SW2: standby for (10,20,30,40), active for (50,70,90)
```
int vlan 10
no shut
...
* CORE-SW1: Advertise 9 network (10, 20, 30, 40, 50, 70, 90, 2 firewall) (hover mouse over switch)
...
* CORE-SW2: Advertise 9 network (10, 20, 30, 40, 50, 70, 90, 2 firewall)
...
* NAT for IT, MEDICAL, ADMIN, WLAN, DMZ, no need for CAMERA, MED-DEVICE, INSIDE-SERVERS to access Internet
