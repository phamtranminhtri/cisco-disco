...
* Network devices:
  * 2911 router x2: WAN-ROUTER (main) and DBP-ROUTER (DBP)
...
* CORE-SW1: Advertise 9 network (10, 20, 30, 40, 50, 60, 70, 90, DBP-ROUTER) (hover mouse over switch)
...
* CORE-SW2: Advertise 9 network (10, 20, 30, 40, 50, 60, 70, 90, DBP-ROUTER)
...
* For CORE-SW1 and CORE-SW2, and DBP-CORE1, DBP-CORE2:
...
deny ip any 172.17.1.0 0.0.0.255
