...
* WAN:
  * WAN-ROUTER: Connect to FW1 in MAIN site
...
* WAN-ROUTER: Advertise 3 network (2 site router, FW1), BUT for now we only advertise 1 site (DBP) + FW1
...
* PERIMETER-FW1: Additional WAN-ROUTER (gig1/6)
